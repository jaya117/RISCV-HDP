...
<details> 
  <summary>  Motion sensitive under the cabinet LED light bar  </summary> 
     ...
     5. Motion sensor activate button - It's also a toggle button when pressed it changes the current state of operation to the other state (permanent ->motiona sensitive
